 ...
 */
public class LadyDetailActivity extends FragmentActivity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_lady_detail);
		...
		if (savedInstanceState == null) {
			...
			arguments.putString(LadyDetailFragment.ARG_ITEM_ID, getIntent()
					.getStringExtra(LadyDetailFragment.ARG_ITEM_ID));
			LadyDetailFragment fragment = new LadyDetailFragment();
			fragment.setArguments(arguments);
			getSupportFragmentManager().beginTransaction()
					.add(R.id.lady_detail_container, fragment).commit();
		}
	}
