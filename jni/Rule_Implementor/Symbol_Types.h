...
enum class Symbol_Types{ 
	...
	, STATEMENT_BLOCK, STATEMENT, IF_STATEMENT, WHILE_STATEMENT, FOR_STATEMENT, STATE_DECLARATION
	, COMPOSITE, BREAK_STATEMENT, RETURN_STATEMENT, PRINT_STATEMENT, STATE_SPECIFICATION, FILTER_SPECIFICATION
	, AGGREGATE, EXPRESSION_TYPE_UNINITIALIZED, ARGUMENTS, ROUTINE, LIST, STATE_ID, END };
